...
print(top)
label_2=tkinter.Label(vWindow,background='#2f3640'
,width=17,height=12)
...
if top[1]=="흰색":
    top_color=PhotoImage(file="aaaa/28.png")
elif top[1]=="흰색계열":
    top_color=PhotoImage(file="aaaa/28.png")
elif top[1]=="핑크":
    top_color=PhotoImage(file="aaaa/25.png")
elif top[1]=="파랑":
    top_color=PhotoImage(file="aaaa/39.png")
elif top[1]=="네이비":
    top_color=PhotoImage(file="aaaa/40.png")
elif top[1]=="노랑":
    top_color=PhotoImage(file="aaaa/33.png")

if bottom[1]=="연청색":
    bottom_color=PhotoImage(file="aaaa/39.png")
elif bottom[1]=="진청색":
    bottom_color=PhotoImage(file="aaaa/32.png")
elif bottom[1]=="베이지":
    bottom_color=PhotoImage(file="aaaa/29.png")
elif bottom[1]=="흰색":
    bottom_color=PhotoImage(file="aaaa/27.png")
elif bottom[1]=="검은색":
    bottom_color=PhotoImage(file="aaaa/31.png")
elif bottom[1]=="카키":
    bottom_color=PhotoImage(file="aaaa/23.png")
elif bottom[1]=="차콜":
    bottom_color=PhotoImage(file="aaaa/26.png")



top_label=tkinter.Label(vWindow,image=top_img)
top_label.place(x=490,y=160)

bottom_lable=tkinter.Label(vWindow,image=bottom_img)
bottom_lable.place(x=490,y=350)
...
label_3=tkinter.Label(vWindow,background='#2f3640'
,width=17,height=12)
...
if configList[1] == 0:
    ...
    fl="추위와 더위를 많이탐"
label_4=tkinter.Label(vWindow,text=ss+"/"+fl,background='#2f3640'
,width=40,height=2)
